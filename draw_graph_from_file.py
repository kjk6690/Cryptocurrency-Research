...
def draw_graph_from_file(filename,circular=False):
    """
    ...
    print("Made Graph")
    if circular:
        nx.draw_circular(G, with_labels=False, node_size=2, linewidths=.5)
    else:
        nx.draw_networkx(G, with_labels=False, node_size=2, linewidths=.5)
    print("Drawn")
    plt.show()